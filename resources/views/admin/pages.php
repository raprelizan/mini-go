                ...
                <tbody>
                    <?php foreach ($pages as $page) : ?>
                        <tr>
                            <form method="post" action="/admin/pages/update">
                                ...
                                <td>
                                    <div class="d-flex flex-column gap-2">
                                        <a class="btn btn-sm btn-outline-info" href="/admin/customizer?page_id=<?= (int) $page['id'] ?>">فتح المخصص</a>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" name="is_enabled" form="toggle-form-<?= (int) $page['id'] ?>" <?= !empty($page['customizer_enabled']) ? 'checked' : '' ?> onchange="this.form.submit()">
                            ...
                            <form id="toggle-form-<?= (int) $page['id'] ?>" method="post" action="/admin/customizer/toggle" class="d-none">
                                <?= csrf_field() ?>
                                <input type="hidden" name="page_id" value="<?= (int) $page['id'] ?>">
                            </form>

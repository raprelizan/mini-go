...
$sidebar = '<div class="brand">لوحة التحكم</div>'
    ...
    . '<a class="nav-link" href="/admin/merchant-registrations"><i class="bi bi-person-plus"></i> طلبات التجار</a>'
    ...
    . '<a class="nav-link" href="/admin/customizer"><i class="bi bi-layout-text-window"></i> مخصص الصفحات</a>'
